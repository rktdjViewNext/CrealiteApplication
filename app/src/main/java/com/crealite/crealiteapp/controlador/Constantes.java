...
public class Constantes {
    public static final String SERVER_URL = "http://172.16.178.206/Crealite";
    ...
    public static final String EXTRA_LISTA_SERVICIO = "LISTA_SERVICIO";
    public static final String FASE_PROYECTO_1 = "ADJUDICACION DE PROFESIONALES";
    public static final String FASE_PROYECTO_2 = "GENERANDO PRESUPUESTO";
    public static final String FASE_PROYECTO_3 = "PRIMER PAGO (70%)";
    public static final String FASE_PROYECTO_4 = "EVENTO REALIZADO";
